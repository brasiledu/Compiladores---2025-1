...
public class TimemaniaLexer extends Lexer {
	...
	public static final int
		...
		LESS=22, LESSEQ=23, GREATER=24, GREATEREQ=25, EQUAL=26, NOTEQUAL=27, AND=28, 
		OR=29, NOT=30, ASSIGN=31, SEMICOLON=32, COMMA=33, LPAREN=34, RPAREN=35, 
		LBRACE=36, RBRACE=37, NUMBER=38, ID=39, STRING=40, COMMENT=41, MULTILINE_COMMENT=42, 
		WS=43;
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"ENTAO", "SENAO", "ENQUANTO", "FACA", "ESCREVA", "LEIA", "VASCO", "PLUS", 
			"MINUS", "MULT", "DIV", "MOD", "OPERATOR", "DELIMITER", "LESS", "LESSEQ", 
			"GREATER", "GREATEREQ", "EQUAL", "NOTEQUAL", "AND", "OR", "NOT", "ASSIGN", 
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			...
			"PLUS", "MINUS", "MULT", "DIV", "MOD", "OPERATOR", "DELIMITER", "LESS", 
			"LESSEQ", "GREATER", "GREATEREQ", "EQUAL", "NOTEQUAL", "AND", "OR", "NOT", 
